def subtract_sum(number):
    fruits = {1: "kiwi", 2: "pear", 3: "kiwi", 4: "banana", 5: "melon", 6: "banana", 7: "melon",
    		 ...
    		 38: "grape", 39: "orange", 40: "grape", 41: "cherry", 42: "pear", 43: "cherry",
    		 44: "pear", 45: "apple", 46: "pear", 47: "kiwi", 48: "banana", 49: "kiwi", 50: "banana",
    		 51: "melon", 52: "pineapple", 53: "melon", 54: "apple", 55: "cucumber", 56: "pineapple",
    ...
    n = number - sum(int(digit) for digit in str(number))
    while not 1 <= n <= 100:
        n = n - sum(int(digit) for digit in str(n))
    return fruits[n]
